...
return '<p><iframe name="radio87-currenttitle" src="http://www.radio87.fr/live3/titre_en_cours/" style="width:655px;height:166px;border:none;" scrolling="auto" frameborder="0"></iframe></p>';
}
add_shortcode('RADIO87CT', 'radio87currenttitle');


function radio87tracklist() {
return '<p><a style="font-size:18px;" href="http://www.radio87.fr/live3/tracklist/" target="_blank" title="RADIO87 - Tracklist">Voir les derniers titres diffusés sur RADIO87.FR</a></p>';
}
add_shortcode('RADIO87TR', 'radio87tracklist');


function radio87localtime() {
return '<p><iframe name="radio87-localtime" src="http://www.radio87.fr/date_heure/heure.php" style="width:144px;height:18px;border:none;" frameborder="0" scrolling="no"></iframe></p>';
}
...
return '<p><input type="button" value="Les podcasts de RADIO87.FR" title="Les podcasts de RADIO87.FR" onclick="window.open(\'http://www.radio87.fr/podcasts/\', \'_blank\')" style="font-family:Arial;font-size:12px;font-weight:bold;color:#FFFFFF;background-color:#FF0000;border-radius:6px;"></p>';
}
add_shortcode('RADIO87PODCASTS', 'radio87podcasts');


function radio87don() {
return '<p><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank"><input type="hidden" name="cmd" value="_xclick"><input type="hidden" name="business" value="contact@radio87.fr"><input type="hidden" name="item_name" value="RADIO87.FR"><input type="hidden" name="item_number" value="Faire un don"><input type="hidden" name="lc" value="FR"><input type="hidden" name="currency_code" value="EUR"><input type="text" name="amount" maxlength="8" value="9.99" style="width:77px;font-family:Arial;font-size:12px;color:#000000;background-color:#FFFFFF;border:1px solid #CCCCCC;border-radius:6px;"> <span style="font-size:12px;">€</span> &nbsp;<input type="submit" value="Faire un don à RADIO87.FR" title="Faire un don à RADIO87.FR" style="font-family:Arial;font-size:12px;font-weight:bold;color:#FFFFFF;background-color:#FF0000;border-radius:6px;"></form></p>';
}
add_shortcode('RADIO87DON', 'radio87don');


function radio87modules() {
return '<p><a style="font-size:18px;" href="http://www.radio87.fr/v2/players-liens.html" target="_blank" title="RADIO87 - Modules">Installer un module RADIO87.FR sur son site</a></p>';
}
add_shortcode('RADIO87MODULES', 'radio87modules');
